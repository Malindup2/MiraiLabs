...
export default function About() {
  ...
  useEffect(() => {
    ...
    // Hover effects
    const hoverElements = document.querySelectorAll('a, button, .value-card, .timeline-item');
    const onMouseEnter = () => {
      if (cursor && ring) {
      ...
      <div className="below-hero min-h-screen pt-40">
        ...
        <section className="py-20 px-6 md:py-[100px] md:px-12 lg:px-20 max-w-[1440px] mx-auto flex flex-col gap-6">
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-light text-white leading-[1.1] tracking-tight max-w-4xl" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Engineering digital architectures that outlast the <em>trends.</em>
          </h1>
          <p className="text-[#777] text-lg max-w-2xl mt-4 leading-relaxed">
            Mirai Labs is an elite engineering and product studio. We build high-performance systems, ledger protocols, and custom software for enterprises operating at global scale.
          </p>
        </section>
        ...
        <section className="py-20 px-6 md:py-[100px] md:px-12 lg:px-20 max-w-[1440px] mx-auto border-t border-[rgba(189,189,189,0.15)] flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="value-card p-8 bg-[rgba(255,255,255,0.015)] border border-[rgba(255,255,255,0.05)] rounded-[24px] hover:border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.02)] transition-all duration-300">
              <span className="text-xs uppercase tracking-widest text-[#555] block mb-6">01 / TECHNICAL EXCELLENCE</span>
              <h3 className="font-serif text-2xl font-light text-white mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Rigor Over Speed</h3>
              <p className="text-sm text-[#777] leading-relaxed">
                We believe in clean code, robust static typing, test-driven methodologies, and architecture that doesn&apos;t build technical debt.
              </p>
            </div>
            <div className="value-card p-8 bg-[rgba(255,255,255,0.015)] border border-[rgba(255,255,255,0.05)] rounded-[24px] hover:border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.02)] transition-all duration-300">
              <span className="text-xs uppercase tracking-widest text-[#555] block mb-6">02 / VISUAL INTEGRITY</span>
              <h3 className="font-serif text-2xl font-light text-white mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Premium Aesthetics</h3>
              <p className="text-sm text-[#777] leading-relaxed">
                A high-performance backend deserves a beautiful user interface. We design details with meticulous care to inspire trust.
              </p>
            </div>
            <div className="value-card p-8 bg-[rgba(255,255,255,0.015)] border border-[rgba(255,255,255,0.05)] rounded-[24px] hover:border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.02)] transition-all duration-300">
              <span className="text-xs uppercase tracking-widest text-[#555] block mb-6">03 / TRUSTED PARTNER</span>
              <h3 className="font-serif text-2xl font-light text-white mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Long-Term Systems</h3>
              <p className="text-sm text-[#777] leading-relaxed">
                We work side-by-side with tech-focused companies. We treat your product infrastructure as if it were our own.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 md:py-[100px] md:px-12 lg:px-20 max-w-[1440px] mx-auto border-t border-[rgba(189,189,189,0.15)] flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-8 max-w-4xl mx-auto w-full">
            <div className="timeline-item flex flex-col md:flex-row justify-between border-b border-[rgba(255,255,255,0.05)] pb-8 gap-4">
              <span className="text-white font-serif text-2xl" style={{ fontFamily: "'Cormorant Garamond', serif" }}>2024 — Inception</span>
              <div className="md:max-w-md">
                <h4 className="text-white font-medium text-base mb-2">Colombo Engineering Center Est.</h4>
                <p className="text-sm text-[#777] leading-relaxed">Founded by a core group of distributed systems engineers and product designers committed to raising engineering standards in the region.</p>
              </div>
            </div>
            <div className="timeline-item flex flex-col md:flex-row justify-between border-b border-[rgba(255,255,255,0.05)] pb-8 gap-4">
              <span className="text-white font-serif text-2xl" style={{ fontFamily: "'Cormorant Garamond', serif" }}>2025 — Scaling Up</span>
              <div className="md:max-w-md">
                <h4 className="text-white font-medium text-base mb-2">Cross-Border Integrations</h4>
                <p className="text-sm text-[#777] leading-relaxed">Partnered with fintech clients in the UAE and ledger firms in Estonia to construct secure cloud pipelines supporting millions of concurrent API calls.</p>
              </div>
            </div>
            <div className="timeline-item flex flex-col md:flex-row justify-between pb-8 gap-4">
              <span className="text-white font-serif text-2xl" style={{ fontFamily: "'Cormorant Garamond', serif" }}>2026 — Present</span>
              <div className="md:max-w-md">
                <h4 className="text-white font-medium text-base mb-2">Global Operations</h4>
                <p className="text-sm text-[#777] leading-relaxed">Leading core digital transformations, building intelligent automation platforms, and scaling custom Web3 solutions for global partners.</p>
              </div>
            </div>
          </div>
        </section>
